                        ...
                        CustomFadeAnimatedContainer(Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: CustomText(
                                  StringResource.mobileApplicationDevelopement,
                                  color: Colors.black,
                                  fontSize: 22,
                                  fontStyle: FontStyle.italic,
                                  fontWeight: FontWeight.w600,
  ...
  Widget _buildMyEducationAndWorkExperience() {
    return Column(
      children: [
        ...
        Padding(
          padding: const EdgeInsets.only(top: 150, bottom: 100, left: 0),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Column(
                ...
                children: [
                  ...
                  _buildEducationWidget(
                      "Bachelor of Engineering", "National Engineering College")
                ],
              ),
              Padding(
